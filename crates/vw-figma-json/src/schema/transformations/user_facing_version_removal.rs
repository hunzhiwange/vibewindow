...
mod tests {
    ...
    fn test_remove_user_facing_version_deeply_nested() {
        ...
        assert!(tree["document"]["children"][0].get("userFacingVersion").is_none());
        assert!(tree["document"]["children"][0]["children"][0].get("userFacingVersion").is_none());
        assert_eq!(
    ...
    fn test_remove_user_facing_version_in_arrays() {
        ...
        assert_eq!(tree["instances"][0].get("name").unwrap().as_str(), Some("Instance1"));
        assert!(tree["instances"][1].get("userFacingVersion").is_none());
        assert_eq!(tree["instances"][1].get("name").unwrap().as_str(), Some("Instance2"));
    }
