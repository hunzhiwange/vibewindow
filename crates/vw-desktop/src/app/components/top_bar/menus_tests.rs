// Tests for plan6 task 837.
const SOURCE: &str = include_str!("menus.rs");
...
#[test]
fn menus_tests_keeps_planned_coverage_targets() {
    for name in ["file_menu", "edit_menu", "view_menu", "help_menu"] {
