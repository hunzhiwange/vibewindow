// Tests for plan6 task 824.
const SOURCE: &str = include_str!("system_settings_transcription.rs");
...
#[test]
fn system_settings_transcription_tests_keeps_planned_coverage_targets() {
