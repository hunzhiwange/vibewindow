...
#[test]
fn theme_palette_returns_default_for_empty_fills() {
    let theme = MindMapTheme {
        id: "empty",
        name: "Empty",
        background_color: 0,
    ...
    assert_eq!(theme.palette(8), 0xFF0000FF);
}
...
#[test]
fn theme_view_palette_cycles_branch_fills() {
    let view = MindMapThemeView {
        background_color: 0,
        root_fill: 0,
        root_text: 0,
